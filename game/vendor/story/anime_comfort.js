    ...
    registry.register('anime_comfort', function (api) {
        ...
        return {
            AnimeComfort_Start: [
                ...
                vn.reversible({ time: 1349, money: -40, items: { ramen: 1, tea: 1 } }),
                'p 22:29 одного дня. Видео началось с простого: «Если хочется кайфануть — сделай японские снеки». И я вдруг понял, что у меня есть рис, нори, яйцо.',
