...
(function (root) {
    ...
    registry.register('anime_comfort', function (api) {
        ...
        return {
            AnimeComfort_Start: [
                vn.goTo('Квартира: Аниме-вечер — старт'),
                ...
                vn.addTime(5),
                'p {{player.time_hhmm}}. Кухня. Варю рис. Рис — как пайка, только мягче. Леплю треугольник, руками, которые должны были держать отвёртку. Получается криво, но съедобно.',
            ...
            AnimeComfort_Atmosphere: [
                vn.goTo('Квартира: Аниме-атмосфера'),
                'show scene workshop with fadeIn duration 1s',
                vn.addTime(9),
                'p {{player.time_hhmm}}. Видео: «Устрой мини-марафон с пледом, выключенным светом и опенингами между сериями». Я выключаю верхний свет. Лампа настольная остаётся — как в куполе Титана ночью.',
            ...
            AnimeComfort_Playlist: [
                vn.goTo('Квартира: Плейлист'),
                'show scene workshop with fadeIn duration 1s',
                vn.addTime(8),
                'p {{player.time_hhmm}}. Видео кидает плейлист: YOASOBI — Racing into the Night, Ado — Odo, Eve — Kaikai Kitan, LiSA — Gurenge, Radwimps — Suzume, Kenshi Yonezu — Kick Back.',
                ...
                vn.addTime(7),
                'p {{player.time_hhmm}}. Третий трек. Рамен уже съеден. На дне — яйцо. Я выловил его палочками, как будто выловил важную деталь из бульона дня.',
