...
(function (root) {
    ...
    registry.register('anime_shorts', function (api) {
        ...
        return {
            AnimeShorts_Init: [
                vn.goTo('Квартира: Лента — одно видео — 22:27'),
                'show scene workshop with fadeIn duration 1s',
                'p 22:27 того же дня. Я листал ленту про пайку и Титана, и алгоритм впервые за вечер сделал не «ещё одно такое же», а «вот тебе одно — другое». Одно видео в ленте среди паяльников.',
            ...
            AnimeShorts_PhoneInit: [
                vn.goTo('Квартира: Телефон — одно видео — 22:27'),
                'show scene workshop with fadeIn duration 1s',
                'p 22:27. Телефон. Среди бесконечных шортсов — одно длинное видео, застряло в ленте, как будто алгоритм ошибся: «Собери аниме-вечер без стыда: рамен, плейлист, косплей из шкафа».',
