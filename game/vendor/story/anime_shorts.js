    ...
    registry.register('anime_shorts', function (api) {
        ...
        return {
            ...
            AnimeShorts_PhoneInit: [
                vn.goTo('Квартира: Телефон — одно видео — 22:41'),
                'show scene workshop with fadeIn duration 1s',
                'p 22:41. Телефон. Среди бесконечных шортсов — одно длинное видео, застряло в ленте, как будто алгоритм ошибся: «Собери аниме-вечер без стыда: рамен, плейлист, косплей из шкафа».',
