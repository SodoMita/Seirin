...
(function (root) {
    ...
    registry.register('anime_nausicaa', function (api) {
        ...
        return {
            AnimeNausicaa_Start: [
                vn.goTo('Квартира: Навсикая — старт'),
                'show scene workshop with fadeIn duration 1s',
                vn.addTime(4),
                'p {{player.time_hhmm}} одного дня. Алгоритм кидает нарезку Навсикаи. Я не включаю фильм целиком — 117 минут сейчас не влезут. Листаю арты, пару сцен из ютуба, тред о концовке.',
            ...
            AnimeNausicaa_Spores: [
                vn.goTo('Квартира: Навсикая — споры'),
                'show scene workshop with fadeIn duration 1s',
