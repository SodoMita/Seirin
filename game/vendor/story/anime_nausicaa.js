...
(function (root) {
    ...
    registry.register('anime_nausicaa', function (api) {
        ...
        return {
            AnimeNausicaa_Start: [
                vn.goTo('Квартира: Навсикая — старт — 02:18'),
                'show scene workshop with fadeIn duration 1s',
                'p 02:18 одного дня. После Евы алгоритм кидает нарезку Навсикаи. Я не включаю фильм целиком — 117 минут сейчас не влезут. Листаю арты, пару сцен из ютуба, тред о концовке.',
            ...
            AnimeNausicaa_Spores: [
                vn.goTo('Квартира: Навсикая — споры — 02:21'),
                'show scene workshop with fadeIn duration 1s',
