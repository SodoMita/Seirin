...
(function (root) {
    ...
    registry.register('anime_gacha', function (api) {
        ...
        return {
            AnimeGacha_Start: [
                vn.goTo('Квартира: Гача — старт — 03:14'),
                'show scene workshop with fadeIn duration 1s',
                'p 03:14 одного дня. После цикад — гача. Видео: нарезка пуллов Star Rail, крик «Броня С-ранг!». Я не крутил сегодня, но смотрю, как другие крутят, и получаю дофамин за них.',
                { Choice: { Dialog: '',
                    GachaHI: routeChoice('Honkai Impact 3rd — последний урок', 'AnimeGacha_HI', { procrastination: 2, philosophical_depth: 2 })
                } }
            ],
            AnimeGacha_HI: [
                vn.goTo('Квартира: Honkai Impact — 03:17'),
                'show scene workshop with fadeIn duration 1s',
            ...
            AnimeGacha_SR: [
                vn.goTo('Квартира: Star Rail — 03:22'),
                'show scene workshop with fadeIn duration 1s',
            ...
            AnimeGacha_Genshin: [
                vn.goTo('Квартира: Genshin и аниме-игры — 03:28'),
                'show scene workshop with fadeIn duration 1s',
            ...
            AnimeGacha_Rhythm: [
                vn.goTo('Квартира: Ритм и пули — 03:34'),
                'show scene workshop with fadeIn duration 1s',
