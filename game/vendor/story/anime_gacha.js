...
(function (root) {
    ...
    registry.register('anime_gacha', function (api) {
        ...
        return {
            AnimeGacha_Start: [
                vn.goTo('Квартира: Гача — старт'),
                'show scene workshop with fadeIn duration 1s',
                vn.addTime(16),
                'p {{player.time_hhmm}} одного дня. После цикад — гача. Видео: нарезка пуллов Star Rail, крик «Броня С-ранг!». Я не крутил сегодня, но смотрю, как другие крутят, и получаю дофамин за них.',
                { Choice: { Dialog: '',
                    GachaHI: routeChoice('Honkai Impact 3rd — последний урок', 'AnimeGacha_HI', { procrastination: 2, philosophical_depth: 2 })
                } }
            ],
            AnimeGacha_HI: [
                vn.goTo('Квартира: Honkai Impact'),
                'show scene workshop with fadeIn duration 1s',
            ...
            AnimeGacha_Genshin: [
                vn.goTo('Квартира: Genshin и аниме-игры'),
                'show scene workshop with fadeIn duration 1s',
