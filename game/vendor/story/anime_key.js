...
(function (root) {
    ...
    registry.register('anime_key', function (api) {
        ...
        return {
            AnimeKey_Start: [
                vn.goTo('Квартира: Key — старт'),
                'show scene workshop with fadeIn duration 1s',
                vn.addTime(14),
                'p {{player.time_hhmm}} одного дня. После Навсикаи алгоритм кидает в Key. Не включаю ВН целиком — 40 часов каждая, один день не резиновый. Листаю VNDB, открываю несколько сцен на ютубе, читаю чужие слёзы.',
            ...
            AnimeKey_SP: [
                vn.goTo('Квартира: Summer Pockets'),
                'show scene workshop with fadeIn duration 1s',
