...
(function (root) {
    ...
    registry.register('anime_key', function (api) {
        ...
        return {
            AnimeKey_Start: [
                vn.goTo('Квартира: Key — старт — 00:45'),
                'show scene workshop with fadeIn duration 1s',
                'p 00:45 одного дня. После Навсикаи алгоритм кидает в Key. Не включаю ВН целиком — 40 часов каждая, один день не резиновый. Листаю VNDB, открываю несколько сцен на ютубе, читаю чужие слёзы.',
            ...
            AnimeKey_Clannad: [
                vn.goTo('Квартира: Clannad — 00:48'),
                'show scene workshop with fadeIn duration 1s',
            ...
            AnimeKey_Rewrite: [
                vn.goTo('Квартира: Rewrite — 01:03'),
                'show scene workshop with fadeIn duration 1s',
            ...
            AnimeKey_SP: [
                vn.goTo('Квартира: Summer Pockets — 01:07'),
                'show scene workshop with fadeIn duration 1s',
                ...
                'p Итог Key: все их ВН — про то, что время — ресурс, который тратишь на мелочи, а потом плачешь, потому что мелочь стала важной. Как я с 21:07 до 01:07 одного дня.',
                { Choice: { Dialog: '',
