...
Stella is the one documented exception.
...
- [ ] Head ratio correct for age band.
...
- [ ] All `core_8` present, plus the record's `expressions_extra`.
...
- [ ] Eyes — same size, same height, same iris size, highlights consistent
      between them (except Lumina, whose perfect symmetry is intentional).
...
- [ ] Minors (Ren 17, Ryuki 16, Momo 15, Hana 13, Miya 5): full costume
      ...
      reads as suggestive.
- [ ] Ryuki's ichthyosis reads as texture and dignity, not wounds or scales.
- [ ] Reika's scar present and unminimised.
